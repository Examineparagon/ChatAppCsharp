...
/// <summary>
/// philipw27@gmail.com	1q
//coffeelaptop @outlook.com    2w
/// </summary>
...
namespace ChatAppV9
{
    public partial class frmMain : Form
    {
        public frmMain()//focus msg prep box, set var defined in lbluser from frmlogin
        {
            ...
            string greetingString = "Welcome " + frmLogin.SetValuetxtUser;

            List<SqlParameter> sqlParams = new List<SqlParameter>();

            SqlParameter sqlParam1 = new SqlParameter("Id", frmLogin.SetValuetxtUser);//GET USERNAME FROM ID BOX//logs user info and begins chat seesion
            SqlParameter sqlParam2 = new SqlParameter("MsgText", greetingString);//send msg
            ...
            DataTable dt = DAL.ExecStoredProcedure("procMsgSent", sqlParams);


            Timer timer = new Timer();
            timer.Interval = (1000); // 1 secs = stops spamming, increase slightly? TODO add button to stop timer
...

        {
...

            {
                ...
                txtReadOnly.Text += "" + Id + " Sent: \r\n" + "" + txtMsg + "\r\n At: " + Created + "\r\n" + Environment.NewLine;//shows id , msg and time created in chat window
